...
if __name__ == "__main__":
    print(nim([3, 4, 5], MISERE))
    print(nim([2, 1, 2], MISERE))
    print(nim([1, 1, 1], MISERE))
    print(nim([1, 2, 3], MISERE))
    print(nim([3, 3, 3], MISERE))
    print(nim([4, 4, 1], MISERE))
    print(nim([4, 1, 4], MISERE))
    print(nim([1, 4, 4], MISERE))
    print(nim([100, 100, 100], MISERE))
    print(nim([100, 0, 0], MISERE))